...
address: "PIK (Potsdam Institute for Climate Impact Research), Kuppel, Albert-Einstein Wissenschaftspark, Telegrafenberg, 14473 Potsdam"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "52.3806054, 13.0642448"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use http://www.latlong.net/) 
...
instructor: ["Martin Hammitzsch (GFZ)", "Stefan Lüdtke (GFZ)", "Marvin Reich (GFZ)", "Till Francke (UP)", "Berry Boessenkool", "Peter Evans (GFZ)", "Robert Gieseke (PIK)", "Daniel Beiter (GFZ)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]

helper: ["Knut Günther (GFZ)", "Joachim Krois (Charité)", "Steffen Kriewald (PIK)", "Michael Dietze (GFZ)", "and instructors"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <p>
        ...
        <a href="http://www.rstudio.com/ide/download/desktop">RStudio IDE</a>. 
        To get the latest R version on Ubuntu, use:<br>
        
        <code>sudo echo "deb http://cran.rstudio.com/bin/linux/ubuntu xenial/" | sudo tee -a /etc/apt/sources.list<br>
        gpg --keyserver keyserver.ubuntu.com --recv-key E084DAB9<br>
        gpg -a --export E084DAB9 | sudo apt-key add -<br>
        sudo apt-get update<br>
        sudo apt-get install r-base r-base-dev</code><br>
        Replace xenial with e.g. trusty if you have another Ubuntu version:
        Ubuntu 16.10 yakkety, 16.04 xenial, 14.04 trusty, 12.04 precise
      </p>
    </div>
  </div>
